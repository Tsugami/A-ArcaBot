...
type DecoratorFunction<R, T = unknown> = (target: T, propertyKey: string, descriptor: PropertyDescriptor) => R

export const logger = (...args: unknown[]): DecoratorFunction<void> => () => console.log(...args)
